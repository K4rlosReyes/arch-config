...
keys = [
    ...
    Key([mod], "e", lazy.spawn(filemanager), desc="Launch PcManfm"),
    # Toggle between different layouts as defined below
    Key([mod], "Tab", lazy.next_layout(), desc="Toggle between layouts"),
    Key([mod], "Space", lazy.layout.toggle_floating(), desc="Toggle floating"),
    ...
    Key([mod], "f", lazy.window.toggle_maximize(), desc="Maximize focused window"),
