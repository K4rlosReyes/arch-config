...
#+begin_src bash
pacman -S xorg git alacritty flameshot mpv emacs qtile qtile-extras-git ranger arandr ark bluez bluez-utils brightnessctl discord dmenu dunst htop ntfs-3g obsidian openssh openssl playerctl pipewire pipewire-alsa pipewire-pulse pipewire-jack stunnel telegram-desktop thunar unzip xorg-xinit zsh yt-dlp lightdm lightdm-gtk-greeter
#+end_src
* Post install
